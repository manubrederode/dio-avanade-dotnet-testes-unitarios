...
## Desafio de projeto
Para este desafio, foi preciso usar os conhecimentos adquiridos no módulo de Testes Unitários com C#, da trilha .NET da DIO.
...
Os gestores aceitaram a ideia, e com isso, é preciso implementar testes unitários no sistema.
